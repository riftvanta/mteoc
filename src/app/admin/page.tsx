...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          <button 
            onClick={refetch}
            disabled={isRefetching}
            className="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jordan disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <Link
            href="/admin/orders"
            className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-jordan hover:bg-jordan-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-jordan transition-colors duration-200"
          >
            View All Orders
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((card, index) => {
          ...
          return (
            <div 
              key={index} 
              className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-all duration-200 transform hover:scale-105 animate-slide-up"
      ...
      {/* Recent Orders */}
      <div className="bg-white rounded-lg border border-gray-200 animate-slide-up" style={{ animationDelay: '400ms' }}>
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/admin/orders"
              className="text-sm text-jordan hover:text-jordan-dark font-medium flex items-center transition-colors duration-200"
            >
              View all
      ...
      {/* Quick Actions */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-slide-up" style={{ animationDelay: '600ms' }}>
        <Link
          href="/admin/exchanges/new"
          className="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-all duration-200 group transform hover:scale-105"
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-gray-900">Add Exchange Office</h3>
              <p className="text-sm text-gray-600">Create new exchange account</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-600">Configure banks & commissions</p>
            </div>
          </div>
        </Link>
      </div>
